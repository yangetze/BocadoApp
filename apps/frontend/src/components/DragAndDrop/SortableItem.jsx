        ...
        {mode === 'baseRecipe' ? (
          <div className="flex items-center gap-2">
            <input
              ...
              className="w-20 text-center font-medium text-slate-gray border border-gray-200 rounded-lg p-1 outline-none focus:border-peach-soft focus:ring-1 focus:ring-peach-soft"
            />
