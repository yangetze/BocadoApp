                ...
                {formData.paymentMethods.map((method, index) => (
                  <div key={index} className="bg-white p-4 rounded-xl border border-gray-200 relative">
                    ...
                    <div className="grid grid-cols-2 gap-4 mb-4 pr-8">
                      <div>
                        <label htmlFor={`payment-type-${index}`} className="block text-xs text-gray-500 mb-1">Tipo de Pago</label>
                        <input
                      ...
                      <div>
                        <label htmlFor={`payment-currency-${index}`} className="block text-xs text-gray-500 mb-1">Moneda</label>
                        <select
                          id={`payment-currency-${index}`}
