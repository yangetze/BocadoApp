...
export default function RegisterPage () {
  ...
  return (
    <div className='min-h-screen bg-white flex flex-col items-center justify-center p-6 relative overflow-hidden'>
      ...
      <div className='absolute top-[-5%] right-[-10%] w-80 h-80 bg-peach-soft/20 rounded-full blur-3xl pointer-events-none' />
      <div className='absolute bottom-[-10%] left-[-5%] w-96 h-96 bg-peach-soft/10 rounded-full blur-3xl pointer-events-none' />
