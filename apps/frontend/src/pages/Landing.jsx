    ...
    <div className='min-h-screen bg-white font-sans text-slate-gray selection:bg-peach-soft/30'>
      ...
      <main className='pt-20'>
        ...
        <section className='relative pt-24 pb-32 overflow-hidden bg-white'>
          <div className='absolute top-[-20%] left-[-10%] w-[600px] h-[600px] bg-peach-soft/15 rounded-full blur-[80px] opacity-60 pointer-events-none' />
          <div className='absolute bottom-[-10%] right-[-10%] w-[500px] h-[500px] bg-peach-soft/10 rounded-full blur-[80px] opacity-60 pointer-events-none' />
          ...
          <div className='max-w-7xl mx-auto px-6 relative z-10 text-center'>
            ...
            >
              <div className='inline-flex items-center gap-2 px-4 py-2 rounded-full bg-peach-soft/10 text-peach-soft border border-peach-soft/20 mb-8 font-medium text-sm'>
                <span className='flex h-2 w-2 rounded-full bg-peach-soft' />
        ...
        <section className='py-20 relative overflow-hidden'>
          <div className='absolute inset-0 bg-slate-gray' />
          <div className='absolute top-[-50%] right-[-10%] w-[600px] h-[600px] bg-peach-soft/20 rounded-full blur-[100px] opacity-50 pointer-events-none' />
