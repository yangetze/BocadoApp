...
- **Manejo de Errores Frontend:** Ningún error hacia la API debe romper la aplicación en el frontend. Debe ser manejado de forma segura, por ejemplo usando un `catch` en las promesas o un bloque `try/catch` para evitar pantallas en blanco o crashes.
