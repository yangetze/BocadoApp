...
export default function Landing() {
  ...
  return (
    <motion.div className="min-h-screen bg-white font-sans text-slate-gray selection:bg-peach-soft/30">

      {/* Navbar */}
      <nav className="fixed w-full top-0 z-40 bg-white/80 backdrop-blur-md border-b border-gray-100/50">
        <motion.div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          <motion.div className="flex items-center gap-3">
            <motion.div className="w-10 h-10 rounded-xl bg-peach-soft flex items-center justify-center text-white shadow-sm shadow-peach-soft/40">
      ...
      <main className="pt-20">
        ...
        <section className="relative pt-24 pb-32 overflow-hidden bg-white">
          <motion.div className="absolute top-[-20%] left-[-10%] w-[600px] h-[600px] bg-peach-soft/15 rounded-full blur-[80px] opacity-60 pointer-events-none"></motion.div>
          <motion.div className="absolute bottom-[-10%] right-[-10%] w-[500px] h-[500px] bg-peach-soft/10 rounded-full blur-[80px] opacity-60 pointer-events-none"></motion.div>

          <motion.div className="max-w-7xl mx-auto px-6 relative z-10 text-center">
            <motion.div
            ...
            >
              <motion.div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-peach-soft/10 text-peach-soft border border-peach-soft/20 mb-8 font-medium text-sm">
          ...
          <motion.div className="max-w-7xl mx-auto px-6">
            ...
            <motion.div className="grid md:grid-cols-3 gap-8">
              {[
                ...
                >
                  <motion.div className="w-14 h-14 rounded-2xl bg-peach-soft/10 text-peach-soft flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
                    {feature.icon}
                  </motion.div>
        ...
        <section className="py-24 bg-white">
          <motion.div className="max-w-4xl mx-auto px-6">
            ...
            <motion.div className="space-y-6">
              {faqs.map((faq, idx) => (
                <motion.div key={idx} className="bg-gray-50/50 p-6 rounded-2xl border border-gray-100">
        ...
        <section className="py-20 relative overflow-hidden">
          <motion.div className="absolute inset-0 bg-slate-gray"></motion.div>
          <motion.div className="absolute top-[-50%] right-[-10%] w-[600px] h-[600px] bg-peach-soft/20 rounded-full blur-[100px] opacity-50 pointer-events-none"></motion.div>

          <motion.div className="max-w-4xl mx-auto px-6 relative z-10 text-center">
      ...
      <footer className="bg-white py-12 border-t border-gray-100">
        <motion.div className="max-w-7xl mx-auto px-6 grid md:grid-cols-3 gap-8">
          <motion.div>
            <motion.div className="flex items-center gap-3 mb-6">
              <motion.div className="w-8 h-8 rounded-lg bg-peach-soft flex items-center justify-center text-white">
        ...
        <motion.div className="max-w-7xl mx-auto px-6 mt-12 pt-8 border-t border-gray-100 text-center text-slate-gray/50 text-sm">
