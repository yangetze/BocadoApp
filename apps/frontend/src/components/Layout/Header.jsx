  ...
  return (
    <header className="bg-white border-b border-gray-100 py-4 px-6 mb-8 sticky top-0 z-10 shadow-sm">
      <div className="max-w-6xl mx-auto flex items-center justify-between">
        <Link to="/app/ingredients" className="flex items-center gap-3 cursor-pointer">
        ...
        <nav className="flex items-center gap-1 bg-gray-50/80 p-1.5 rounded-xl border border-gray-100 overflow-x-auto">
          <NavLink to="/app/ingredients" className={navLinkClass}>
            Ingredientes
          </NavLink>
          <NavLink to="/app/base-recipes" className={navLinkClass}>
            Recetas Base
          </NavLink>
          <NavLink to="/app/super-recipes" className={navLinkClass}>
